...
def generate_launch_description():
    ...
    robot_description_content = Command([
        ...
        PathJoinSubstitution([
            FindPackageShare("thor_hardware_interface"), "urdf", "thor.urdf.xacro"
        ]),
        " ",
        "name:=thor",
        " ",
    ...
    joint_controllers_cfg = PathJoinSubstitution([
        FindPackageShare("thor_hardware_interface"), "config", "controllers.yaml"
    ])

    update_rate_config_file = PathJoinSubstitution([
        FindPackageShare("thor_hardware_interface"),
        "config",
