...
def generate_launch_description():
    ...
    robot_description_content = Command([
        ...
        " ",
        PathJoinSubstitution([
            FindPackageShare("thor_moveit_config"), "urdf", "fake_thor.urdf.xacro"
        ]),
        " ",
        "name:=ar",
    ])
    ...
    robot_description_semantic_content = Command([
        ...
        " ",
        PathJoinSubstitution(
            [FindPackageShare("thor_moveit_config"), "srdf", "thor.srdf.xacro"]),
        " ",
        "name:=ar",
    ])
    ...
    ompl_planning_yaml = load_yaml("thor_moveit_config",
    ...
    # RViz
    rviz_base = os.path.join(get_package_share_directory("thor_moveit_config"),
                             "rviz")
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("thor_hardware_interface"),
        "config",
        "controllers.yaml",
    )
